...
class Home extends MX_Controller {
	...
	{
		$data['data'] = $this -> Categories_model -> __get_categories($this -> permission_lib -> sesresult['ufaculty']);
	...
	public function add()
	{
		if ($_POST) {
			...
			$data['cparent'] = $this -> categories_lib -> __get_categories_level(0, $this -> permission_lib -> sesresult['ufaculty']);
	...
	public function edit($id)
	{
		if ($_POST) {
			...
			$data['cparent'] = $this -> categories_lib -> __get_categories_level($data['data'][0] -> cparent, $this -> permission_lib -> sesresult['ufaculty']);
			$this->load->view('categories_' . __FUNCTION__, $data);
		}
	}
