                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo __get_error_msg(); ?>
                                    <form action="<?php echo site_url('testimony/add'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control input-default" placeholder="Full Name">
                                        </div>
                                        <div class="form-group">
                                            <label>Current Company</label>
                                            <input type="text" name="company" class="form-control input-default" placeholder="Current Company">
                                        </div>
                                        <div class="form-group">
                                            <label>Testimony</label>
                                        <textarea class="form-control" rows="3" placeholder="Enter text ..." name="testimony" style="height:100px"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Photo</label>
