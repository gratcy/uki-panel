                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php if (__get_roles('GalleryCategoriesExecute')) : ?>
                                    <div class="col-6">
                                        <a href="<?php echo site_url('categories_gallery/add'); ?>" class="btn btn-primary"><i class="icon-plus"></i> Add New</a>
                                    </div>
                                <?php endif; ?>
                                        ...
                                        <tbody>
                                            <?php foreach($data as $k => $v) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (__get_roles('GalleryCategoriesExecute')) : ?>
                                                          <a href="<?php echo site_url('categories_gallery/edit/' . $v -> cid); ?>"><i class="fa fa-pencil"></i></a>
                                                          &nbsp;
