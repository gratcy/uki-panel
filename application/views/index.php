                                ...
                                <div class="recent-meaasge">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img alt="..." src="<?php echo site_url('assets'); ?>/images/avatar/1.jpg" class="media-object"></a>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img alt="..." src="<?php echo site_url('assets'); ?>/images/avatar/2.jpg" class="media-object"></a>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img alt="..." src="<?php echo site_url('assets'); ?>/images/avatar/3.jpg" class="media-object"></a>
                                        </div>
                                        <div class="media-body">
